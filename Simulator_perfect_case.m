...
imwrite(H_ref,'Hartmannograms\with_integr_m.bmp'); 
...
imshow(H,[]);
% Save to the "Hartmannograms" folder 
imwrite(H,'Hartmannograms\Hartmannogram_DEF_500_integr.bmp');
...
fig1 = fopen('Files_txt\Reference_integ.txt', 'w'); 
...
fig2 = fopen('Files_txt\Shifted_centers_integ.txt', 'w'); 
